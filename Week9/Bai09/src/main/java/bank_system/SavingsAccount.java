...
public class SavingsAccount extends Account {
  ...
  public void deposit(double amount) throws BankException {
    ...
    LOGGER.info("Deposit completed for savings account {}, amount {}", getAccountNumber(), amount);
  }
  ...
  public void withdraw(double amount) throws BankException {
    if (amount > MAX_WITHDRAW_AMOUNT || getBalance() - amount < MIN_BALANCE) {
      LOGGER.warn(
          "Rejected savings withdrawal for account {}, amount {}", getAccountNumber(), amount);
    ...
    LOGGER.info("Withdraw completed for savings account {}, amount {}", getAccountNumber(), amount);
  }
}
