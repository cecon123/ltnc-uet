...
**4. Hàm main:**
    - Viết hàm main tạo đối tượng Solution, gọi đến hàm fibonacci thử nghiệm
...
**2. Phương thức (Methods):**
    **-** gcd (int a, int b): Để tìm ước số chung lớn nhất của 2 số nguyên a và b.
       Kiểu trả về int. **Yêu cầu:**
    - Triển khai hàm gcd.
    - Viết hàm main tạo đối tượng solution, gọi đến hàm gcd. Thử nghiệm các
...
**2. Yêu cầu:**
    ...
    **-** Viết hàm main tạo đối tượng Solution, gọi đến hàm isPrime. Thử với các
       giá trị n khác nhau (số âm, số rất lớn, ...) và in ra kết quả.
...
**1. Phương thức (Methods):**
    - isPalindrome(int n): Để kiểm tra xem một số nguyên n có phải là số
...
2. **Hàm khởi tạo (Constructors):**
    ○ Constructor nhận vào accountNumber và ownerName. Số dư mặc định là
       0.
...
Tạo lớp CentralHub:Một class với phương thức duy nhất là registerDevice(SmartLight
